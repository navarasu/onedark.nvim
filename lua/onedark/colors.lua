local colors = {
  ...
  dark_purple = { '#8a3fa0', '#7e3992' , '#8f36a9' , '#862aa1' , '#854897' , '#79428a' },
   ...
   diff_green = { '#587738', '#587738' , '#587738' , '#587738' , '#587738' , '#587738' }, --
    diff_blue = { '#354A77', '#354A77' , '#354A77' , '#354A77' , '#354A77' , '#354A77' }, --
    diff_add =  { '#1E2326', '#1E2326' , '#1E2326' , '#1E2326' , '#1E2326' , '#1E2326' }, --
  diff_change = { '#262b3d', '#262b3d' , '#262b3d' , '#262b3d' , '#262b3d' , '#262b3d' }, --
  diff_delete = { '#281B27', '#281B27' , '#281B27' , '#281B27' , '#281B27' , '#281B27' }  --
}
