...
hl.common = {
    ...
    NormalNC = { fg = c.fg, bg = cfg.transparent and c.none or c.bg_inactive},
    Terminal = {fg = c.fg, bg = cfg.transparent and c.none or c.bg0},
    EndOfBuffer = {fg = cfg.ending_tildes and c.bg2 or c.bg0, bg = cfg.transparent and c.none or c.none},
    FoldColumn = {fg = c.fg, bg = cfg.transparent and c.none or c.none},
    Folded = {fg = c.fg, bg = cfg.transparent and c.none or c.none},
    SignColumn = {fg = c.fg, bg = cfg.transparent and c.none or c.none},
    ToolbarLine = {fg = c.fg},
    Cursor = {fmt = "reverse"},
    vCursor = {fmt = "reverse"},
    iCursor = {fmt = "reverse"},
    ...
    StatusInactive = { fg = c.none, bg = c.bg_inactive },
    StatusNormal = { fg = c.none, bg = c.green },
    StatusInsert = { fg = c.none, bg = c.blue },
    StatusVisual = { fg = c.none, bg = c.purple },
    StatusReplace = { fg = c.none, bg = c.red },
    StatusCommand = { fg = c.none, bg = c.yellow },
    StatusTerminal = { link = "StatusInsert" },
    -- TabLine = {fg = c.fg, bg = c.bg1},
    TabLine = {fg = c.fg, bg = c.none},
